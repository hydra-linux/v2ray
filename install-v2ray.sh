...
# Define ANSI color code for blue
width=$(tput cols)
if [ "$width" -lt 120 ]; then
    echo -e "${RED}Warning: Your terminal is too narrow. This script requires a width of at least 120 columns.${RESET}"
fi



sudo tee /bin/editvpn << 'EOF'
#!/bin/bash
sudo nano /usr/local/etc/v2ray/config.json
EOF

sudo tee /bin/v2help << 'EOF'
#!/bin/bash
...
# Using ANSI escape code to set the text color to blue
echo -e "${BLUE}###################################################"
echo -e "###################################################"
echo -e "###################################################"
echo -e "###                                             ###"
echo -e "###   db    db .d888b. d8888b.  .d8b.  db    db ###"
echo -e "###   88    88 VP  \`8D 88  \`8D d8' \`8b \`8b  d8' ###"
echo -e "###   Y8    8&    odD' 88oobY' 88ooo88  \`8bd8'  ###"
echo -e "###   \`8b  d8'  .88'   88\`8b   88~~~88    88    ###"
echo -e "###    \`8bd8'  j88.    88 \`88. 88   88    88    ###"
echo -e "###      YP    888888D 88   YD YP   YP    YP    ###"
echo -e "###                                             ###"
echo -e "###                                             ###"
echo -e "###   d88888b  .d88b.  d8888b. d8888b. d8888b.  ###"
echo -e "###   88'     .8P  Y8. 88  \`8D 88  \`8D 88  \`8D  ###"
echo -e "###   88ooooo 88    88 88oooY' 88oobY' 88   88  ###"
echo -e "###   88~~~~~ 88    88 88~~~b. 88\`8b   88   88  ###"
echo -e "###   88.     \`8b  d8' 88   8D 88 \`88. 88  .8D  ###"
echo -e "###   Y88888P  \`Y88P'  Y8888P' 88   YD Y8888D'  ###"
echo -e "###                                             ###"
echo -e "###################################################"
echo -e "###################################################${RESET}"
# Blue line
echo -e "${BLUE}##created by telegram: @EOBRD${RESET}"
# Green lines
echo -e "${GREEN}##type : v2help    ## How to use:${RESET}"
echo -e "${GREEN}##type : editvpn   ## To set the config,${RESET}"
echo -e "${GREEN}than pase your v2ray config in JSON${RESET}"
echo -e "${GREEN}##type : startvpn  ## To run proxy vpn${RESET}"
echo -e "${GREEN}##type : stopvpn   ## to stop proxy vpn${RESET}"
echo -e "${GREEN}##type : getv2ray  ## to get your proxy${RESET}"
EOF

sudo tee /bin/Startvpn << 'EOF'
#!/bin/bash
...
GREEN="\033[0;32m"
RESET="\033[0m" # Resets the color to default terminal color
# Use echo to print each line of ASCII art in blue
...
echo -e "###################################################\033[0m"
# Blue line
echo -e "\033[0;32mProxy successfully activated.\033[0m"
EOF


sudo tee /bin/stopvpn << 'EOF'
#!/bin/bash
...
echo -e "###################################################\033[0m"
# Blue line
echo -e "\033[0;32mProxy successfully disabled.\033[0m"
EOF


sudo tee /bin/getv2ray << 'EOF'
#!/bin/bash
sudo ss -lnpt | grep v2ray
EOF


sudo chmod +x /bin/editvpn /bin/Startvpn /bin/stopvpn /bin/getv2ray
sudo chmod +x /bin/v2help
...
# Red line
echo -e "${RED}##The installation was successful.${RESET}"
